...
- the installed extension version and GNOME Shell version;
...
Agents Tray Limits starts the locally installed Codex CLI and reads account and rate-limit data from Codex App Server. Reports are particularly useful when they concern:
